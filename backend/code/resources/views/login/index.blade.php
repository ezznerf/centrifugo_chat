            ...
            <div class="col-sm-6 text-black d-flex align-items-center justify-content-center">
                <div class="w-100 px-4" style="max-width: 30rem;">
                    ...
                    <form class="mt-5" action="/login" method="POST">
                        @csrf
                        <h1 class="fw-bold text-center mb-5" style="letter-spacing: 1px;">Log in</h1>
                        ...
                        <p class="text-center">Don't have an account? <a href="#!" class="link-info">Register here</a></p>
                    </form>
                </div>
            </div>
